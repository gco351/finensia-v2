...
const FallingBackground = () => {
  ...
  useEffect(() => {
    ...
    const newIcons = Array.from({ length: 20 }).map((_, i) => ({
      ...
      animationDuration: `${Math.random() * 5 + 5}s`, // 5-10s fall time
...
export default function App() {
  ...
  const [docs, setDocs] = useState<any[]>([
    ...
    {
      img: "https://placehold.co/800x500/1e293b/f97316?text=Webinar+Online",
  ...
  return (
    ...
    >
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8">
            ...
            <div className="bg-white p-6 md:p-8 rounded-3xl shadow-sm border border-slate-100 hover-lift group cursor-default">
              ...
              <p className="text-slate-600 mb-6">
                Pencatatan transaksi keuangan secara rapi dan sesuai standar.
              </p>
            ...
            <div className="bg-white p-6 md:p-8 rounded-3xl shadow-sm border border-slate-100 sm:col-span-2 md:col-span-1 hover-lift group cursor-default">
              ...
              <p className="text-slate-600 mb-6">
                Menyusun struktur akun, merancang alur transaksi dan SOP keuangan terintegrasi.
              </p>
              <div className="pt-6 border-t border-slate-100">
                <p className="text-sm text-slate-500 mb-1">Mulai dari</p>
        ...
        <div className="max-w-3xl mx-auto px-6">
          ...
          <div className="space-y-4">
            {faqs.map((faq, index) => (
              ...
              >
                <button 
                  className="w-full px-5 md:px-6 py-4 md:py-5 text-left flex justify-between items-center font-bold text-slate-800 text-sm md:text-base"
                ...
                {activeFAQ === index && (
                  <div className="px-5 md:px-6 pb-4 md:pb-5 text-slate-600 border-t border-slate-100 pt-4 text-sm md:text-base">
                    {faq.a}
                  </div>
                )}
              </div>
      ...
      >
        <span className="absolute right-16 bg-white text-slate-800 text-sm font-bold px-4 py-2 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity shadow-lg pointer-events-none whitespace-nowrap">
          Hubungi Kami!
        </span>
